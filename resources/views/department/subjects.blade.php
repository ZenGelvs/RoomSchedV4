                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('department.assignSubjects', ['section_id' => $section->id, 'subject_id'=>$subject->id, 'program_name' => $section->program_name, 'year_level' => $section->year_level]) }}" class="btn btn-primary">Assign Subjects</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
